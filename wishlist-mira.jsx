...
const WISHLIST_ITEMS = [
  ...
  {
    id: 2,
    title: "GC Tooth Mousse — зубной гель для реминерализации",
    price: "1 624 ₽",
  ...
  {
    id: 8,
    title: "Мерч любимых мультиков",
    price: "",
    link: null,
    store: "",
    emoji: "📺",
    category: "fun",
    note: "Кошечки-Собачки, Малышарики, Совёнок Хоп-Хоп — фигурки, наклейки, раскраски",
  },
  {
    id: 10,
    title: "Mustela — питательный стик с холодным кремом",
    price: "",
    link: "https://ozon.ru/t/ofvTPY0",
    store: "Ozon",
    emoji: "🧴",
    category: "practical",
  },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Или можно просто перевести деньгами
          </div>
          <div
            style={{
              fontFamily: "'Nunito', sans-serif",
          ...
          >
            Если ничего из списка не приглянулось — мы будем рады любому вкладу в копилку для Миры
          </div>
          <div
            style={{
              display: "inline-flex",
